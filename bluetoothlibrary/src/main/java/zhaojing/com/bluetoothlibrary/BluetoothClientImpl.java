...
import zhaojing.com.bluetoothlibrary.connect.response.BluetoothResponse;
import zhaojing.com.bluetoothlibrary.model.BleGattProfile;
import zhaojing.com.bluetoothlibrary.receiver.BluetoothReceiver;
import zhaojing.com.bluetoothlibrary.receiver.listener.BleCharacterChangeListener;
import zhaojing.com.bluetoothlibrary.receiver.listener.BleConnectStatusChangeListener;
import zhaojing.com.bluetoothlibrary.receiver.listener.BluetoothBondListener;
import zhaojing.com.bluetoothlibrary.receiver.listener.BluetoothBondStateChangeListener;
import zhaojing.com.bluetoothlibrary.receiver.listener.BluetoothStateChangeListener;
...
import static zhaojing.com.bluetoothlibrary.Constants.EXTRA_GATT_PROFILE;
...
import static zhaojing.com.bluetoothlibrary.Constants.EXTRA_RSSI;
...
import static zhaojing.com.bluetoothlibrary.Constants.REQUEST_SUCCESS;
...
import static zhaojing.com.bluetoothlibrary.Constants.SERVICE_UNREADY;
import static zhaojing.com.bluetoothlibrary.Constants.CODE_REQUEST_MTU;
import static zhaojing.com.bluetoothlibrary.Constants.GATT_DEF_BLE_MTU_SIZE;

/**
 * Created by zhaojing on 16/4/8.
 */
...
//            BluetoothLog.v(String.format("onServiceConnected"));
            mBluetoothService = IBluetoothService.Stub.asInterface(service);//代理对象
            //这里面可以进行延时 看一下，因为在主线程中
