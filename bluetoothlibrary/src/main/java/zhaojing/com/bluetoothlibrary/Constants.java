...
public class Constants {
     ...
     */
    public static final int REQUEST_SUCCESS = RequestState.REQUEST_SUCCESS;
    public static final int REQUEST_FAILED = RequestState.REQUEST_FAILED;
    public static final int REQUEST_CANCELED = RequestState.REQUEST_CANCELED;
    public static final int ILLEGAL_ARGUMENT = RequestState.ILLEGAL_ARGUMENT;
    public static final int BLE_NOT_SUPPORTED = RequestState.BLE_NOT_SUPPORTED;
    public static final int BLUETOOTH_DISABLED = RequestState.BLUETOOTH_DISABLED;
    public static final int SERVICE_UNREADY = RequestState.SERVICE_UNREADY;
    public static final int REQUEST_TIMEDOUT = RequestState.REQUEST_TIMEDOUT;
    public static final int REQUEST_OVERFLOW = RequestState.REQUEST_OVERFLOW;
    public static final int REQUEST_DENIED = RequestState.REQUEST_DENIED;
    public static final int REQUEST_EXCEPTION = RequestState.REQUEST_EXCEPTION;
